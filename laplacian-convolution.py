...
# Define the Laplacian filter kernels
laplacian_kernel = np.array([[0, 1, 0],
                             [1, -4, 1],
                             [0, 1, 0]], dtype=np.float32)

larger_laplacian_kernel = np.array([[1, 1, 1],
                             [1, -8, 1],
                             [1, 1, 1]], dtype=np.float32)

# Perform convolution. You can chose either of the kernels here, just replace the kernel variable
